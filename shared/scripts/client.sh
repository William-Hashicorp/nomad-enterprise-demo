...
RETRY_JOIN=$2
NOMAD_BINARY=$3
DATACENTER=$4  # Added datacenter parameter
REGION=$5      # Added region parameter
...
sed -i "s/DATACENTER/$DATACENTER/g" $CONFIGDIR/nomad_client.hcl  # Added datacenter replacement
sed -i "s/REGION/$REGION/g" $CONFIGDIR/nomad_client.hcl   # Added region replacement
